...
question("Welches Gütekritierium empirisches Forschung kann durch eine zufällige Stichprobe positiv beeinflusst werden?",
...
question("Im welchen Jahr war der Anteil der teilnehmenden Frauen am größten?",
         answer("2017", message = "Die Höhe der Balken gibt den relativen Anteil der Geschlechter an."),
         answer("2018", message = "Die Höhe der Balken gibt den relativen Anteil der Geschlechter an."),
         answer("2019", correct = TRUE, message = "Die Höhe der Balken gibt den relativen Anteil der Geschlechter an.")
         )
```

```{r Laueferanteil, echo=FALSE}
question("Im welchen Jahr gab es die meisten Teilnehmer*innen?",
         answer("2017", correct = TRUE, message = "Die Breite der Balken gibt den relativen Anteil der Jahre an."),
         answer("2018", message = "Die Breite der Balken gibt den relativen Anteil der Jahre an."),
         answer("2019", message = "Die Breite der Balken gibt den relativen Anteil der Jahre an.")
         )
```