...
Viele Zusammenhänge sind nicht linear, daher werden hier verschiedene Zusammenhänge, häufig z.B. auch Logarithmus, `log()`, betrachtet:
...
Eine Lineare Regression der Quadratwurzel des Preises (bei Prognose (oder Interpretation): Rücktransformation nicht vergessen) auf Karat und Farbe ergibt folgendes Ergebnis:
