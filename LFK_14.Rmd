...
Variablen die auf den kausalen Pfad von *Bildungsausgaben* $\rightarrow$ *Testergebnis* liegen sollten nicht adustiert werden (d.h. *Klassengröße* und *Gehalt Lehrer\*in*). Blockiert durch Adjustierung werden die nicht-kausalen Pfade, d.h. die mit Pfeilen in die erklärende Variable.
