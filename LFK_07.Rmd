...
```{r Skala, echo=FALSE}
question("Welches Skalenniveau hat die Getriebe (`getriebe`)?",
         answer("Kategorial – nominal", correct = TRUE, message = "Für nominales Skalenniveau könnten die Werte nur unterschieden werden."),
...
question("Welche Fahrzeuge haben im Modell, bei gegebenen Gewicht, im Mittelwert einen geringeren Spritverbrauch?",
         answer("Autos mit Automatikgetriebe.", correct = TRUE, message = "Der geschätzte Koeffizient (`Estimate`) für die Variable `getriebe`, wenn `Schaltung == TRUE` ist, ist größer als Null. D.h., bei gegeben das Gewicht (`kg`) steigt der Spritverbrauch (`lp100km`) wenn ein Schaltgetriebe vorliegt."),
         answer("Autos mit Schaltgetriebe.", message = "Der geschätzte Koeffizient (`Estimate`) für die Variable `getriebe`, wenn `Schaltung == TRUE` ist, ist größer als Null. D.h., bei gegeben das Gewicht (`kg`) steigt der Spritverbrauch (`lp100km`) wenn ein Schaltgetriebe vorliegt."),
         answer("Beide gleich.",  message = "Der geschätzte Koeffizient (`Estimate`) für die Variable `getriebe`, wenn `Schaltung == TRUE` ist, ist größer als Null. D.h., bei gegeben das Gewicht (`kg`) steigt der Spritverbrauch (`lp100km`) wenn ein Schaltgetriebe vorliegt.")
         )
```
