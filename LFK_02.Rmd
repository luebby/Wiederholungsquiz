...
question("Welches Skalenniveau hat die Variable *Art des Mediums* (Video, Audio, Dokument)?",
         ...
         answer("Numerisch – intervallskaliert", message = "Für eine Intervallskalierung müssten die Werte auch in eine Reihenfolge gebracht werden können und die Abstände vergleichbar. Der Nullpunkt ist willkürlich."),
         answer("Numerisch – verhältnisskaliert", message = "Für eine Verhältnisskalierung müssten die Werte auch in eine Reihenfolge gebracht werden können und die Abstände vergleichbar. Auch ist ein absoluter Nullpunkt (inhaltlich) gegeben.")         
         )
```
