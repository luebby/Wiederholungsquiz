...
question("Welche Koeffizienten passen zu obiger Abbildung?",
         answer("$\\alpha=30, \\beta=10$", message = "An der Stelle $x=0$ ist $y>0$, also ist der Achsenabschnitt $\\alpha>0$. Die Gerade fällt, also ist die Steigung $\\beta<0$."),
         answer("$\\alpha=30, \\beta=-10$", correct = TRUE, message = "An der Stelle $x=0$ ist $y>0$, also ist der Achsenabschnitt $\\alpha>0$. Die Gerade fällt, also ist die Steigung $\\beta<0$."),
         answer("$\\alpha=-30, \\beta=10$", message = "An der Stelle $x=0$ ist $y>0$, also ist der Achsenabschnitt $\\alpha>0$. Die Gerade fällt, also ist die Steigung $\\beta<0$."),
         answer("$\\alpha=-30, \\beta=-10$", message = "An der Stelle $x=0$ ist $y>0$, also ist der Achsenabschnitt $\\alpha>0$. Die Gerade fällt, also ist die Steigung $\\beta<0$.")
         )
```
