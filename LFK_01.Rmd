...
question("Ist die Aussage *Studierende, die die Vorlesung aktiv nacharbeiten, bestehen die Klausur* im Sinne Poppers eine wissenschaftliche Hypothese?",
         ...
         answer("Nein",  message = "Die Aussage kann empirisch wiederlegt werden.")
         )
```
...
question("Welches Gütekritierium des wissenschaftlichen Schlusses *Kontinuierliche Mitarbeit ist zum Bestehen nicht erforderlich* primär verletzt?",
         ...
         answer("Externe Validität", correct = TRUE, message = "Das Ergebnis von Vorlesung $X$ kann nicht übertragen werden.")
         )
```
